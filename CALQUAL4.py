...
#A3=pd.DataFrame()
#pd.concat([A3,pd.DataFrame(Parallel(n_jobs=10,backend="multiprocessing", verbose=10)(delayed(calqual)(i) for i in imgs[800:804]))],join='inner')
#B3=A3.append(Parallel(n_jobs=10,backend="multiprocessing", verbose=10)(delayed(calqual)(i) for i in imgs))
#B3.to_pickle("~/sensplot202009290730.pkl")
