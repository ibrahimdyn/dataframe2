...
def lc_annulus(IM):
   ...
   #     print count, "/", len(imagess)
    ...
    if (np.nanstd(fitsimg.data[0,0,:,:]) < 1000.0) & (np.nanstd(fitsimg.data[0,0,:,:]) > 10.0):
        ...
        with open(r'/home/idayan/FILESofGIT/LC_ANNULUS_stdup-_202007061557.csv', 'a') as f:
            writer = csv.writer(f)
        ...
        with open('/home/idayan/FILESofGIT/LC_ANNULUS_stdup-_202007061557.pkl', 'a') as ff:
