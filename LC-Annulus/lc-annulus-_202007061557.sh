...
echo "reserving images"
ls /zfs/helios/filer1/idayan/CALed/202007061557/2*.fits > lc-annulus-_202007061557.txt
echo "number of reserved images is:"
echo $(wc -l lc-annulus-_202007061557.txt)
echo "in the file named lc-annulus-_202007061557.txt"
...
do
    ...
    LINE=$(sed -n "$N"p ~/lc-annulus-_202007061557.txt)
