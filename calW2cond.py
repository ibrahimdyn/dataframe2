...
def process(cfg):
	...
	#with open(r'/home/idayan/fit_results_202006231232.csv', 'a') as f:
	#with open(r'/home/idayan/fit_results_202006201232.csv', 'a') as f:
	
	#with open(r'/home/idayan/fit_results_202011270912.csv', 'a') as f:
	...
	#with open(r'/home/idayan/fit_results_202010191408.csv', 'a') as f:
	#with open(r'/home/idayan/fit_results_202010030719.csv', 'a') as f:
	#with open(r'/home/idayan/fit_results_202006041433.csv', 'a') as f:
  ...
  #with open(r'/home/idayan/fit2_results.csv', 'a') as f:
	...
	if (slope_cor < 1e8) and ( _STD_ < 0.55):
